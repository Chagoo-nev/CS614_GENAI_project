...
def check_answer_directly(generated_solution, reference_answer):
    ...
    Args:
        generated_solution: Answer generated by Llama-3.1-8B
    ...
    if not ref_answer:
        return False  # Return false if the dataset answer format is incorrect
    
    # Extract the model-generated answer
    pred_answer = extract_numeric_answer(generated_solution)
    if not pred_answer:
        return False  # Return false if the model output format is incorrect
